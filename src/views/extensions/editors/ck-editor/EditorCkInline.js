...
import CkInlineEditor from "../../../../components/CK-Editor/CkInlineEditor";
...
const EditorCkInline = () => {
    ...
    return (
        <React.Fragment>
            <Row>
                <Col sm={12}>  
                    <ModuleNotification message="For more info please check the components's official documentation" link='https://www.npmjs.com/package/@ckeditor/ckeditor5-react' />
                </Col>
            </Row>
            <Row>
                <Col>
