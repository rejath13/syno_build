...
const ProjectEditForm = (props) => {
  ...
  const { companies = [], salesPersons = [], projectData = {} } = props;
  ...
  const [salesDate, setSalesDate] = useState(moment(projectData.salesDate).format('DD-MM-yyyy'))
  const [selectedCompanyCustomer, setSelectedCompanyCustomer] = useState('');

  var _ap = salesPersons.find((s) => s.user_name == projectData.salePerson) || salesPersons[0];

  const [activeSalesPerson, setActiveSalesPerson] = useState(_ap);
  ...
  useEffect(() => {
    setSelectedCompanyCustomer(projectData.clientName)
  }, [])
    ...
    <React.Fragment>
        ...
        <Row>
          ...
          <Col>
            <Select
              ...
              defaultValue={finalCompanies.find((c) => c.value == projectData.company)}
              onChange={(d) => {
        ...
        <Col>
          <Form.Group controlId="leadSource">
            ...
            <Select
              ...
              name="leadSource"
              options={leadSource}
              defaultValue={leadSource.find((ls) => ls.value == projectData.leadSource) || leadSource[0]}
        ...
        <Col>
          <Form.Group controlId="leadType">
            ...
            <Select
              ...
              name="leadType"
              options={leadType}
              defaultValue={leadType.find((ls) => ls.value == projectData.leadType) || leadType[0]}
        ...
        <Col>
          <Form.Group controlId="implementationType">
            ...
            <Select
              ...
              defaultValue={implementationType.find((ls) => ls.value == projectData.implementationType) || implementationType[0]}
      ...
      <Row>
        ...
        <Col>
          <Form.Group controlId="pricing">
            ...
            <Form.Control name="pricing" defaultValue={projectData.pricing} type="number" placeholder="" />
          </Form.Group>
        </Col>
        ...
        <Col>
          <Form.Group controlId="projectStatus">
            ...
            <ReactSelect
              ...
              defaultValue={projectStatus.find((ls) => ls.value == projectData.projectStatus) || projectStatus[0]}
        ...
        <Col>
          <Form.Group controlId="contactName">
            ...
            <Form.Control
              ...
              type="text"
              placeholder=""
              defaultValue={projectData.contactName}
            />
          </Form.Group>
        </Col>
        ...
        <Col>
          <Form.Group controlId="contactNumber">
            ...
            <Form.Control
              ...
              type="text"
              placeholder=""
              defaultValue={projectData.contactNumber}
            />
          </Form.Group>
        </Col>
      ...
      <Col>
              ...
              <Form.Label>Trade Number</Form.Label>
                <Form.Control
                  defaultValue={projectData?.tradeNumber ? projectData?.tradeNumber : ''} 
                  name="tradeNumber"
                  type="text"
        ...
        <Col>
          <Form.Group controlId="billedTo">
            ...
            <Form.Control name="billedTo" type="text" defaultValue={projectData.billedTo} placeholder="" />
          </Form.Group>
        </Col>
