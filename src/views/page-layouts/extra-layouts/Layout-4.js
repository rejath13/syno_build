...
const Layout4 = () => {
    ...
    useEffect(() => {
        ...
        dispatch({type: actionType.CHANGE_SUB_LAYOUT, subLayout: 'layout-4'});
        ...
        <React.Fragment>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as='h5'>Pre Build Layout 4</Card.Title>
                        </Card.Header>
                        <Card.Body>
                                ...
                                <tr>
                                    <td>
                                        <ul>
                                            ...
                                            <li><mark>subLayout: <code>layout-4</code></mark></li>
