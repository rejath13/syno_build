...
const Layout2 = () => {
    ...
    useEffect(() => {
        ...
        dispatch({type: actionType.CHANGE_SUB_LAYOUT, subLayout: 'layout-2'});
        ...
        <React.Fragment>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as='h5'>Pre Build Layout 2</Card.Title>
                        </Card.Header>
                        <Card.Body>
                                ...
                                <tr>
                                    <td>
                                        <ul>
                                            ...
                                            <li><mark>subLayout: <code>layout-2</code></mark></li>
