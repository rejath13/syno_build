...
const Layout3 = () => {
    ...
    useEffect(() => {
        ...
        dispatch({type: actionType.CHANGE_SUB_LAYOUT, subLayout: 'layout-3'});
        ...
        <React.Fragment>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as='h5'>Pre Build Layout 3</Card.Title>
                        </Card.Header>
                        <Card.Body>
                                ...
                                <tr>
                                    <td>
                                        <ul>
                                            ...
                                            <li><mark>subLayout: <code>layout-3</code></mark></li>
