...
const BasicCollapse = () => {
    ...
    return (
        <React.Fragment>
            <Row>
                <Col sm={12}>  
                    <ModuleNotification message="For more info please check the components's official documentation" link='https://react-bootstrap.netlify.app/components/accordion/' />
                </Col>
            </Row>
            <Row className='btn-page'>
                    <Col sm={12}>
                        ...
                        <Card>
                            <Card.Header>
                                <Button onClick={() => setIsBasic(!isBasic)} aria-controls="basic-collapse" aria-expanded={isBasic}>Collapse Link</Button>
                    ...
                    <Col sm={12}>
                        ...
                        <hr/>
                        <Button onClick={() => targetHandler('target1')} aria-controls="target1" aria-expanded={(isMultiTarget.findIndex(item => item === 'target1') > -1)}>Toggle first element</Button>
                        <Button onClick={() => targetHandler('target2')} aria-controls="target2" aria-expanded={(isMultiTarget.findIndex(item => item === 'target2') > -1)}>Toggle second element</Button>
