...
function DynamicTable({
  ...
  const {
  ...
  } = useTable(
    {
      ...
      initialState: {
        pageIndex: 0,
        sortBy: [{ id: "customer_service_created_date", desc: true }],
      },
    ...
    <>
            ...
            <Row>
              <Col xs={9}>
                <Row
                  className="mr-3"
                  style={{
                    backgroundColor: "#87ceeb17",
                    color: "orangered",
                    borderBottom: "1px solid skyblue",
                  }}
                >
                  <div className="p-2 mr-3">Level 1</div>
                  <div className="checkbox d-inline mr-3">
                    <Form.Control
                      type="checkbox"
                      variant="warning"
                      name="open"
                      value="false"
                      checked={filterarray["open"]}
                      id="open"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="open" className="cr m-0">
                      Open [{levelOneOpenCount}]
                    </Form.Label>
                  </div>
                  <div className="checkbox d-inline mr-2">
                    <Form.Control
                      type="checkbox"
                      name="initiated"
                      value="false"
                      checked={filterarray["initiated"]}
                      id="initiated"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="initiated" className="cr m-0">
                      Initiated
                    </Form.Label>
                  </div>
                  <div className="checkbox d-inline">
                    <Form.Control
                      ...
                      name="verified"
                      value="false"
                      checked={filterarray["verified"]}
                      id="verified"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="verified" className="cr m-0">
                      Verified
                    </Form.Label>
                  </div>
                </Row>
                <Row
                  className="mr-3 mb-2"
                  style={{ backgroundColor: "#87ceeb17", color: "green" }}
                >
                  ...
                  <div className="checkbox d-inline mr-3">
                    <Form.Control
                      ...
                      name="open2"
                      value="false"
                      checked={filterarray["open2"]}
                      id="open2"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="open2" className="cr m-0">
                      Open [{levelTwoOpenCount}]
                    </Form.Label>
                  </div>
                  <div className="checkbox d-inline mr-2">
                    <Form.Control
                      ...
                      name="initiated2"
                      value="false"
                      checked={filterarray["initiated2"]}
                      id="initiated2"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="initiated2" className="cr m-0">
                      Initiated
                    </Form.Label>
                  </div>
                  <div className="checkbox d-inline">
                    <Form.Control
                      ...
                      name="verified2"
                      value="false"
                      checked={filterarray["verified2"]}
                      id="verified2"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="verified2" className="cr m-0">
                      Verified
                    </Form.Label>
                  </div>
                </Row>
                ...
                <Row>
                  <div className="checkbox d-inline">
                    <Form.Control
                      ...
                      name="jobcreated"
                      value="false"
                      checked={filterarray["jobcreated"]}
                      id="jobcreated"
                      onChange={handleMainFilterChange}
                    />
                    <Form.Label htmlFor="jobcreated" className="cr m-0">
                      Job Created
                    </Form.Label>
                  </div>
                </Row>
          ...
          <Col xs={2}>
            ...
            {searchText && (
              <button
                ...
                style={{ right: "5px", height: "auto", marginTop: "14px" }}
              ></button>
            )}
          </Col>
          <Col xs={3}>
      ...
      <Modal size="lg" show={isFilter} onHide={() => setisFilter(false)}>
        ...
        <Modal.Body>
              ...
              <Form.Group>
                <div className="checkbox d-inline">
                  <Form.Control
                    ...
                    name="new"
                    value="false"
                    checked={filterarray["new"]}
                    id="new"
                    onChange={handleFilterArrayChange}
                  />
                  <Form.Label htmlFor="new" className="cr">
                    New
                  </Form.Label>
                </div>
              </Form.Group>
              ...
              <Form.Group>
                <div className="checkbox d-inline">
                  <Form.Control
                    ...
                    name="hold"
                    value="false"
                    checked={filterarray["hold"]}
                    id="hold"
                    onChange={handleFilterArrayChange}
                  />
                  <Form.Label htmlFor="hold" className="cr">
                    Hold
                  </Form.Label>
                </div>
              </Form.Group>
              ...
              <Form.Group>
                <div className="checkbox d-inline">
                  <Form.Control
                    ...
                    name="ongoing"
                    value="false"
                    checked={filterarray["ongoing"]}
                    id="ongoing"
                    onChange={handleFilterArrayChange}
                  />
                  <Form.Label htmlFor="ongoing" className="cr">
                    Ongoing
                  </Form.Label>
                </div>
              </Form.Group>
              ...
              <Form.Group>
                <div className="checkbox d-inline">
                  <Form.Control
                    ...
                    name="completed"
                    value="false"
                    checked={filterarray["completed"]}
                    id="completed"
                    onChange={handleFilterArrayChange}
                  />
                  <Form.Label htmlFor="completed" className="cr">
                    Completed
                  </Form.Label>
                </div>
              </Form.Group>
              ...
              <Form.Group>
                <div className="checkbox d-inline">
                  <Form.Control
                    ...
                    name="applicable"
                    value="false"
                    checked={filterarray["applicable"]}
                    id="applicable"
                    onChange={handleFilterArrayChange}
                  />
                  <Form.Label htmlFor="applicable" className="cr m-0">
                    Applicable
                  </Form.Label>
                </div>
              </Form.Group>
              ...
              <Form.Group>
                <div className="checkbox d-inline">
                  <Form.Control
                    ...
                    name="notapplicable"
                    value="false"
                    checked={filterarray["notapplicable"]}
                    id="notapplicable"
                    onChange={handleFilterArrayChange}
                  />
                  <Form.Label htmlFor="notapplicable" className="cr m-0">
                    Not applicable
                  </Form.Label>
                </div>
              </Form.Group>
                  ...
                  <Form.Group>
                    <div className="checkbox d-inline">
                      <Form.Control
                        ...
                        name="invoiced"
                        value="false"
                        checked={filterarray["invoiced"]}
                        id="invoiced"
                        onChange={handleFilterArrayChange}
                      />
                      <Form.Label htmlFor="invoiced" className="cr m-0">
                        Invoiced
                      </Form.Label>
                    </div>
                  </Form.Group>
                  ...
                  <Form.Group>
                    <div className="checkbox d-inline">
                      <Form.Control
                        ...
                        name="notinvoiced"
                        value="false"
                        checked={filterarray["notinvoiced"]}
                        id="notinvoiced"
                        onChange={handleFilterArrayChange}
                      />
                      <Form.Label htmlFor="notinvoiced" className="cr m-0">
                        Not Invoiced
                      </Form.Label>
                    </div>
                  </Form.Group>
                  ...
                  <Form.Group>
                    <div className="checkbox d-inline">
                      <Form.Control
                        ...
                        name="paid"
                        value="false"
                        checked={filterarray["paid"]}
                        id="paid"
                        onChange={handleFilterArrayChange}
                      />
                      <Form.Label htmlFor="paid" className="cr m-0">
                        Paid
                      </Form.Label>
                    </div>
                  </Form.Group>
                  ...
                  <Form.Group>
                    <div className="checkbox d-inline">
                      <Form.Control
                        ...
                        name="notpaid"
                        value="false"
                        checked={filterarray["notpaid"]}
                        id="notpaid"
                        onChange={handleFilterArrayChange}
                      />
                      <Form.Label htmlFor="notpaid" className="cr m-0">
                        Not paid
                      </Form.Label>
                    </div>
                  </Form.Group>
          ...
          <hr />
          <Row>
            <p className="text-primary w-100" style={{ paddingLeft: "15px" }}>
              Service/Job Created Date Range
            </p>
        ...
        <Modal.Footer>
          ...
          <Button variant="danger" onClick={() => clearPopupFilter()}>
            Clear
          </Button>
        </Modal.Footer>
      </Modal>
...
function App() {
  ...
  const updateMNote = (reminderdata) => {
    updateNote(
      reminderdata.customer_service_id,
      reminderdata.customer_service_description
    );
  ...
  const saveNote = async (data) => {
    const postdata = {
      ...data,
      note_text: data.note_text.replace(/\r?\n/g, "<br/>"),
      note_date: reminderDate
  ...
  const showStatusPopup = (servicedata) => {
    ...
    if (
      servicedata.note_date !== "0000-00-00 00:00:00" &&
      servicedata.note_date !== ""
    ) {
    ...
    resetStatusChange({
      service_id: servicedata.customer_service_id,
      service_status: servicedata.customer_service_status,
      note_text: servicedata.note_text,
    });
  ...
  const onSubmitStatusChange = async (data) => {
    if (
      data.service_status === "hold" &&
      (reminderDate === "" || data.note_text === "")
    ) {
      let msgtext = "";

      if (!reminderDate && data.note_text === "")
        msgtext = "Please fill date and remark.";
      else if (!reminderDate) msgtext = "Please select a date.";
      else if (data.note_text === "") msgtext = "Please type remark.";
    ...
    () => [
      {
        ...
        Cell: ({ row }) => {
          const formattedDate = Moment(
            row.original.customer_expiry_date
          ).format("MMM-YYYY");
          ...
          return (
            <>
              <span
                ...
                onClick={() => editService(row.original.customer_service_id)}
              >
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip id={`tooltip-top`}>Service Created Date</Tooltip>
                  }
                >
                  <span>
                    {Moment(row.original.customer_service_created_date).format(
                      "DD-MM-YYYY"
                    )}
                    <br />
                  </span>
              ...
              <OverlayTrigger
                placement="top"
                overlay={
                  <Tooltip id={`tooltip-top`}>No Connection Devices</Tooltip>
                }
              >
                <Badge
                  variant="danger"
                  style={{ fontSize: "13px", minWidth: "35px" }}
                >
                  {row.original.Noconnection}
                </Badge>
              </OverlayTrigger>
              <br />
              <OverlayTrigger
                placement="top"
                overlay={<Tooltip id={`tooltip-top`}>Expiry Date</Tooltip>}
              >
                <span
                  className={
                    findMonthDifference(row.original.customer_expiry_date) > 0
                      ? "text-danger"
                      : "text-primary"
                  }
                >
              ...
              <span className="ml-1">(by {row.original.user_name})</span>
            </>
          );
        },
      },
        ...
        Cell: ({ row }) => {
          return (
            <span
              ...
              onClick={() => editService(row.original.customer_service_id)}
            >
              {row.original.customer_service_description}
            </span>
          );
        },
      },
        ...
        Cell: ({ row }) => {
          return (
            ...
            >
              ...
              >
                <span>
                  {row.original.customer_service_quantity}
                  <br />
                </span>
              </OverlayTrigger>

              <span>
                {row.original.customer_service_payment === "notapplicable"
                  ? "Not applicable"
                  : "Applicable"}
                <br />
                {row.original.customer_service_invoice_status === "notinvoiced"
                  ? "Not Invoiced"
                  : row.original.customer_service_invoice_status === "invoiced"
                  ? "Invoiced"
                  : ""}
                <br />
                {row.original.customer_service_payment_status === "notpaid"
                  ? "Not paid"
                  : row.original.customer_service_payment_status === "paid"
                  ? "Paid"
                  : ""}
                <br />
            ...
            <>
              ...
              >
                <p className="initiated-section">
                  {row.original.customer_service_L1_support_initiated_date &&
                    Moment(
                      row.original.customer_service_L1_support_initiated_date
                    ).format("DD-MM-YYYY HH:mm A")}
                  {row.original.customer_service_L1_support_initiated_by && (
                    <span className="ml-1" style={{ fontSize: "10px" }}>
                      ({row.original.customer_service_L1_support_initiated_by})
                    </span>
                  )}

                  {row.original.customer_service_L1_support_status ===
                    "open" && (
                    <Badge
                      onClick={() => {
                        ...
                        if (confirmBox === true) {
                          initiatedStatusChange(
                            "initiated",
                            row.original.customer_service_id,
                            1
                          );
                        }
                      }}
                  ...
                  {row.original.customer_service_L1_support_status !==
                    ...
                    <Badge
                      onClick={() => {
                        if (
                          row.original
                            .customer_service_L1_support_initiated_by ===
                            loginUserName &&
                          row.original.customer_service_L1_support_status !==
                            "verified"
                        ) {
              ...
              {row.original.customer_service_L1_support_status !== "open" && (
                ...
                >
                  <p className="verified-section">
                    {row.original.customer_service_L1_support_verified_date &&
                      Moment(
                        row.original.customer_service_L1_support_verified_date
                      ).format("DD-MM-YYYY HH:mm A")}
                    {row.original.customer_service_L1_support_verified_by && (
                      <span className="ml-1" style={{ fontSize: "10px" }}>
                        ({row.original.customer_service_L1_support_verified_by})
                      </span>
                    )}
                    ...
                    {row.original.customer_service_L1_support_status ===
                      ...
                      <Badge
                        onClick={() => {
                          if (
                            row.original
                              .customer_service_L1_support_verified_by ===
                              loginUserName &&
                            row.original.customer_service_L2_support_status ===
                              "notassigned"
                          ) {
                            const confirmBox = window.confirm(
              ...
              {row.original.customer_service_L1_support_note && (
                ...
                >
                  <p
                    ...
                    style={{ padding: "4px 8px 0", margin: 0 }}
                    onClick={() => {
                      if (
                        row.original
                          .customer_service_L1_support_initiated_by ===
              ...
              {!row.original.customer_service_L1_support_note && (
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip id={`tooltip-top`}>Add level 1 note</Tooltip>
                  }
                >
                  <Button
                    className="m-1 ml-2 px-1 py-0"
                    variant="primary"
                    onClick={() => {
                      setSupportNote(
                        row.original.customer_service_L1_support_note
              ...
              {row.original.customer_service_L1_support_status === "verified" &&
                row.original.customer_service_L2_support_status ===
                  "notassigned" && (
                  <OverlayTrigger
                    placement="top"
                    overlay={
                      <Tooltip id={`tooltip-top`}>Assign for level 2</Tooltip>
                    }
                  >
                    <Button
                      className="m-1 ml-2 px-1 py-0"
                ...
                <>
                  ...
                  >
                    <p className="initiated-section">
                      {row.original.customer_service_L2_support_status ===
                        "open" &&
                        row.original.customer_service_assigned_to !==
                          loginUserName && (
                          <span className="pl-2">
                            Level 2 assigned to{" "}
                            {row.original.customer_service_assigned_to}
                      ...
                      {row.original
                        .customer_service_L2_support_initiated_date &&
                        Moment(
                          row.original
                            .customer_service_L2_support_initiated_date
                        ).format("DD-MM-YYYY HH:mm A")}
                      {row.original
                        .customer_service_L2_support_initiated_by && (
                        <span className="ml-1" style={{ fontSize: "10px" }}>
                          (
                          {
                            row.original
                  ...
                  {row.original.customer_service_L2_support_status !==
                    ...
                    <OverlayTrigger
                      placement="top"
                      overlay={
                        <Tooltip id={`tooltip-top`}>L2 Verified</Tooltip>
                      }
                    >
                      <p className="verified-section">
                        {row.original
                          .customer_service_L2_support_verified_date &&
                          Moment(
                            row.original
                              .customer_service_L2_support_verified_date
                          ).format("DD-MM-YYYY HH:mm A")}
                        {row.original
                          .customer_service_L2_support_verified_by && (
                          <span className="ml-1" style={{ fontSize: "10px" }}>
                            (
                            {
                              row.original
                  ...
                  {!row.original.customer_service_L2_support_note &&
                    row.original.customer_service_assigned_to ===
                      ...
                      <OverlayTrigger
                        placement="top"
                        overlay={
                          <Tooltip id={`tooltip-top`}>Add level 2 note</Tooltip>
                        }
                      >
                        <Button
                          className="m-1 ml-2 px-1 py-0"
          ...
          return (
            <>
              <div
                ...
                className={`text-capitalize ${
                  row.original.customer_service_status === "completed"
                    ? "text-success"
                    : ""
                }`}
                style={{ cursor: "pointer" }}
              >
                ...
                {row.original.customer_service_status_change_time && (
              ...
              {row.original.customer_service_job_created === 0 && (
                ...
                >
                  <Button
                    ...
                    onClick={() => {
                      const confirmBox = window.confirm(
                        "Are you sure you want to create new job for this service?"
                      );
                      if (confirmBox === true) {
                        createJobforService(
                          1,
              ...
              {row.original.customer_service_job_created === 1 && (
                <OverlayTrigger
                  placement="top"
                  overlay={
                    <Tooltip id={`tooltip-top`}>Job Created Date/By </Tooltip>
                  }
                >
                  <span style={{ color: "orange" }}>
                    <b>Job Created</b> <br />
                    <span style={{ fontSize: "11px" }}>
                      {row.original.customer_service_job_created_date &&
                        Moment(
                          row.original.customer_service_job_created_date
                        ).format("DD-MM-YYYY")}{" "}
                      /{row.original.customer_service_job_created_by}
                    </span>
                  </span>
                </OverlayTrigger>
              )}
            ...
            <span style={{ cursor: "pointer" }}>
              {row.original.note_text === "" && (
                ...
                >
                  ...
                  >
                    <i className="fas fa-comment m-0"></i>
                  </Button>
                </OverlayTrigger>
              )}
              {row.original.note_text && (
                ...
                >
                  ...
                  <span className="ml-2" style={{ fontSize: "11px" }}>
                    [
                    {row.original.note_date &&
                      Moment(row.original.note_date).format("DD-MM-YYYY")}
                    ]
                  </span>
                </span>
              )}
  ...
  const getCustomerList = useCallback(async () => {
    ...
    try {
      ...
      const url = API_URL + "ListParentCustomers";
  ...
  const createJobforService = async (value, serviceid) => {
    try {
      const options = {
        method: "get",
        headers: {
      ...
      const url = `${API_URL}createJobforService/${serviceid}/${value}`;
      ...
      if (value === 1) successmsg = "Job added successfully";
      else successmsg = "Job deleted";
  ...
  const getCustomerServiceList = useCallback(
    async ({ pageIndex, searchText, sortBy, filterarray, dateRange }) => {
      setIsLoading(true);
      ...
      const postdata = {
        ...
        searchstatus: filterarray,
        jobCreatedDateRange: dateRange,
      };
  ...
  const {
    register: registerRemoveReminder,
    handleSubmit: handleSubmitRemoveReminder,
    reset: resetRemoveReminder,
  } = useForm({
    defaultValues: {
  ...
  return (
    <React.Fragment>
          ...
          <Card>
            <Card.Body style={{ padding: "15px" }}>
              <DynamicTable
                ...
                dueCount={dueCount}
                levelOneOpenCount={levelOneOpenCount}
                levelTwoOpenCount={levelTwoOpenCount}
              />
            </Card.Body>
          </Card>
        </Col>
      ...
      <Modal
        show={servicePopup}
        onHide={() => setServicePopup(false)}
        backdrop="static"
      >
        <Modal.Header closeButton>
          <Modal.Title as="h5">
            {selectedServiceId ? "Edit Service" : "Add Service"}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <CustomerServiceForm
            ...
            customers={customers}
            refreshCustomerDropdown={refreshCustomerDropdown}
          />
        </Modal.Body>
      </Modal>

      <Modal
        show={statusEditPopup}
        onHide={() => setStatusEditPopup(false)}
        backdrop="static"
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmitStatusChange(onSubmitStatusChange)}>
            ...
            <Col
              md={12}
              style={{ paddingTop: "1rem", borderTop: "1px solid #dee2e6" }}
            ...
            >
              ...
              <Button
                variant="secondary"
                onClick={() => setStatusEditPopup(false)}
              >
                Close
              </Button>
            </Col>
                          ...
                          >
                            ...
                            <div className="media-body">
                              <h6 className="media-heading text-muted">
                                ...
                                <span className="f-12 text-muted ml-1">
                                  {Moment(note.created_at).format(
                                    "DD MMM YYYY HH:MM"
                                  )}
                                </span>
                                {note.note_by === loginUserName && (
                                  <span
                                    onClick={() => fillformtoedit(note)}
                                    style={{
                                      marginLeft: "10px",
                                      color: "#04a9f5",
                                    }}
                                ...
                                {getDifferenceInDays(note.note_date) ? (
                                  ...
                                  >
                                    {note.note_date !== "0000-00-00 00:00:00"
                                      ? "[" +
                              ...
                              {note.remove_reminder_text && (
                                <p style={{ fontStyle: "italic", margin: 0 }}>
                                  [{ReactHtmlParser(note.remove_reminder_text)}]{" "}
                                </p>
                              )}
                            </div>
                          </li>
                        ...
                        >
                          ...
                          >
                            <Button
                              variant="success"
                              style={{ fontSize: "10px" }}
                              onClick={() => changeReminderDate("tomorrow")}
                            >
                              T
                            </Button>
                          </OverlayTrigger>
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-top`}>One Week</Tooltip>
                            }
                          >
                            <Button
                              variant="warning"
                              style={{ fontSize: "10px", "line-height": 0.5 }}
                              onClick={() => changeReminderDate("1w")}
                            >
                              {" "}
                              1 W
                            </Button>
                          ...
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-top`}>Two Week</Tooltip>
                            }
                          >
                            <Button
                              variant="danger"
                              style={{ fontSize: "10px", "line-height": 0.5 }}
                              onClick={() => changeReminderDate("2w")}
                            >
                              2 W
                            </Button>
                          </OverlayTrigger>
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-top`}>One Month</Tooltip>
                            }
                          >
                            <Button
                              variant="secondary"
                              style={{ fontSize: "10px", "line-height": 0.5 }}
                              onClick={() => changeReminderDate("1m")}
                            >
                              {" "}
                              1 M
                            </Button>
                          ...
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-top`}>Three Month</Tooltip>
                            }
                          >
                            <Button
                              variant="info"
                              style={{ fontSize: "10px", "line-height": 0.5 }}
                              onClick={() => changeReminderDate("3m")}
                            >
                              3 M
                            </Button>
                          </OverlayTrigger>
                          <OverlayTrigger
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-top`}>Six Month</Tooltip>
                            }
                          >
                            <Button
                              variant="light"
                              style={{ fontSize: "10px", "line-height": 0.5 }}
                              onClick={() => changeReminderDate("6m")}
                            >
                              6 M{" "}
                            </Button>
                          </OverlayTrigger>
      ...
      <Modal
        show={supportNotePopup}
        onHide={() => setSupportNotePopup(false)}
        backdrop="static"
      >
        <Modal.Header closeButton>
        ...
        <Modal.Body>
          <Form>
            ...
            <Col
              ...
              className="text-right pr-0"
            >
              <Button variant="success" onClick={() => saveSupportNote()}>
                Submit
              </Button>
              <Button
                variant="secondary"
                onClick={() => setSupportNotePopup(false)}
              >
                Close
              </Button>
            </Col>
            ...
            <Col md="6">
              <ButtonGroup>
                <Button
                  ...
                  onClick={() => setRemSearchDate("today")}
                >
                  Today ({todayCount})
                </Button>
                <Button
                  variant={
                    remSearchDate === "due" ? "warning" : "outline-warning"
                  }
                  onClick={() => setRemSearchDate("due")}
                ...
                <Button
                  variant={
                    remSearchDate === "upcoming" ? "warning" : "outline-warning"
                  }
                  onClick={() => setRemSearchDate("upcoming")}
                >
            ...
            <Col md="4">
              <Form.Control
                ...
                onChange={(e) => {
                  ...
                  if (!keyword) setSearchReminder(null);
                  else setSearchReminder(keyword);
                }}
                onKeyPress={(e) => {
                  if (e.code === "Enter" || e.code === "NumpadEnter") {
                    e.preventDefault();
                ...
                <Card.Body style={{ height: "80vh", padding: "10px 25px" }}>
                  {reminders && reminders.length > 0 ? (
                          ...
                          <tr>
                            ...
                            >
                              <img
                                ...
                                src={
                                  reminder.note_by === "admin"
                                    ? adminprofile
                                    : reminder.note_by === "Shams"
                                    ? shamsprofile
                                    : reminder.note_by === "Shamnad"
                                    ? shamnadprofile
                                    : reminder.note_by === "Rasick"
                                    ? rasickprofile
                                    : reminder.note_by === "Ajmal"
                                    ? ajmalprofile
                                    : reminder.note_by === "Celine"
                                    ? celineprofile
                                    : reminder.note_by === "Shone"
                                    ? shoneprofile
                                    : adminprofile
                                }
                                alt="Generic placeholder"
                            ...
                            <td
                              ...
                              style={{ cursor: "pointer" }}
                            >
                              {reminder.customer_service_description}
                              <br />({reminder.customer_name})<br />
                              <OverlayTrigger
                                placement="top"
                                overlay={
                                  <Tooltip id={`tooltip-top`}>
                              ...
                              >
                                <span style={{ fontSize: "11px" }}>
                                  {Moment(reminder.created_at).format(
                                    "DD-MM-YYYY HH:mm:ss"
                                  )}
                                </span>
                              </OverlayTrigger>
                            ...
                            >
                              <span
                                className={
                                  getDifferenceInDays(reminder.note_date)
                                    ? "text-danger"
                                    : ""
                                }
                              >
                                {reminder.note_date !== "0000-00-00 00:00:00"
                                  ? Moment(reminder.note_date).format(
                                      "DD-MM-YYYY HH:mm:ss"
                                    )
                                  : ""}
                              </span>
                            ...
                            <td
                              ...
                              style={{ cursor: "pointer" }}
                            >
                              {ReactHtmlParser(reminder.note_text)}
                            </td>
                            <td
                              onClick={() => updateMNote(reminder)}
                              style={{ cursor: "pointer" }}
                            >
                              {reminder.customer_service_status}
                            </td>
                            <td>
                              <OverlayTrigger
                                placement="top"
                    ...
                    <p style={{ marginTop: "30px" }}>
                      No Reminders for the selected time
                    </p>
                  )}
                </Card.Body>
              </Card>
      ...
      <Modal
        show={remindertextPopup}
        onHide={() => setReminderTextPopup(false)}
        backdrop="static"
        style={{ top: "35px", borderWidth: "2px" }}
      >
        <Form onSubmit={handleSubmitRemoveReminder(removeReminderDate)}>
              ...
              <Col>
                <Form.Group controlId="exampleForm.ControlTextarea1">
                  <Form.Control
                    as="textarea"
                    rows="3"
                    {...registerRemoveReminder("remove_reminder_text")}
                    placeholder="Say something about removing reminder"
                    required
                  />
                </Form.Group>
              </Col>
          ...
          <Modal.Footer>
            ...
            <Button
              variant="secondary"
              onClick={() => setReminderTextPopup(false)}
            >
              Close
            </Button>
          </Modal.Footer>
      ...
      <Modal
        show={level2AssignPopup}
        onHide={() => setLevel2AssignPopup(false)}
        backdrop="static"
      >
        <Modal.Header closeButton>
          ...
          <Form onSubmit={handleSubmitAssignLevel2(onSubmitAssignLevel2)}>
            <Row style={{ marginBottom: "10px" }}>
              <Col md={12}>
                ...
                <Form.Control
                  as="select"
                  {...level2assignregister("customer_service_assigned_to")}
                  onChange={(e) => {
                    resetLevel2Assign({
                      ...getLevel2AssignValues(),
                      customer_service_assigned_to: e.target.value,
                    });
                  }}
                >
                  <option value="">Select</option>
                  {users
                    .filter((user, index) => user.user_id !== 1)
                    .map((user) => (
            ...
            >
              ...
              <Button
                variant="secondary"
                onClick={() => setLevel2AssignPopup(false)}
              >
                Close
              </Button>
            </Col>
