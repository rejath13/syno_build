            ...
            <Row>
                        ...
                        <Card.Body>
                            ...
                            <div className="row">
                                <div className="col-6 m-t-20">
                                    ...
                                    <h6 className=" text-muted f-w-300 m-b-0">Deals Added<span className="float-right f-w-400">69%</span></h6>
                                    <div className="progress m-t-10" style={{height: '7px'}}>
                                        <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '69%'}} aria-valuenow="69" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                                <div className="col-6 m-t-20">
                                    <h6 className="text-muted">89</h6>
                                    <h6 className=" text-muted f-w-300 m-b-0">Deals Won<span className="float-right f-w-400">58%</span></h6>
                                    <div className="progress m-t-10" style={{height: '7px'}}>
                                        <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '58%'}} aria-valuenow="58" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                            </div>
                        </Card.Body>
                        ...
                        <Card.Body>
                            ...
                            <div className="row m-t-30">
                                <div className="col-6 p-r-0">
                                    <Link to='#' className="btn btn-primary text-uppercase btn-block">add friend</Link>
                                </div>
                                <div className="col-6">
                                    <Link to='#' className="btn text-uppercase border btn-block btn-outline-secondary">message</Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card>
                        <Card.Body className='border-bottom'>
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col">
                                    <h2 className="f-w-300">26°<span className=" m-r-3 f-14 text-muted">Sunny</span></h2>
                    ...
                    <Card className='theme-bg2'>
                        <Card.Body>
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col">
                                    <h2 className="f-w-300 text-white">26°<span className=" m-r-3 f-14 text-white">Sunny</span></h2>
                        ...
                        <Card.Body>
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col">
                                    ...
                                    <span className="d-block">Last week 295 <strong className="text-c-green f-w-300">(+88)</strong></span>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                        ...
                        <Card.Body>
                            <div className="row">
                                ...
                                <div className="col text-right">
                                    ...
                                    <span className="text-white d-flex align-items-center justify-content-end  p-1"><i className="fa fa-caret-up text-white f-26 m-r-10"/> 56.68%</span>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                ...
                <Col md={6} xl={4}>
                    <Card className='profit-bar'>
                        <Card.Body>
                            ...
                            <h6 className="m-t-20 text-muted"><span className="badge theme-bg  text-white m-r-10">+11%</span>From Previous Month </h6>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <div className="row align-items-center justify-content-center">
                                <div className="col-6">
                                    <h2 className="f-w-300 d-flex align-items-center float-left">4.3 <i className="fa fa-star f-12 m-l-10 text-c-yellow"/></h2>
                                </div>
                                <div className="col-6">
                                    <h6 className="f-w-300 d-flex  align-items-center float-right">0.4 <i className="fa fa-caret-up text-c-green f-24 m-l-10"/></h6>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="row align-items-center justify-content-center">
                                ...
                                <div className="col-6">
                                    <Link to='#' className="btn btn-primary shadow-2 text-uppercase btn-block">Pay now</Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="row align-items-center justify-content-center">
                                ...
                                <div className="col-auto">
                                    <span className="text-c-green f-18">15% <i className="feather icon-arrow-up-right f-20"/></span>
                                </div>
                            </div>
                            <div className="row m-t-25">
                                <div className="col-6">
                                    <Link to='#' className="btn btn-primary  text-uppercase btn-block">Deposit</Link>
                                </div>
                                <div className="col-6 p-l-0">
                                    <Link to='#' className="btn text-uppercase border btn-block btn-outline-secondary">withdraw</Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <div className="row align-items-center justify-content-center">
                                <div className="col-auto">
                                    <h3 className="f-w-300 m-t-20">$59,48<i className="fa fa-caret-up text-c-green f-26 m-l-10"/></h3>
                                    <span>EARNINGS</span>
                                </div>
                                <div className="col text-right">
                            ...
                            <div className="leads-progress mt-3">
                                <h6 className="mb-3 text-center">Organic <span className="ml-4">Purchesed</span></h6>
                                <div className="progress">
                                    <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '30%', height: '10px'}} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"/>
                                    <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '36%', height: '10px'}} aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"/>
                                </div>
                                <h6 className="text-muted f-w-300 mt-4">Organic Leads <span className="float-right">340</span></h6>
                                <h6 className="text-muted f-w-300 mt-4">Purchesed Leads <span className="float-right">150</span></h6>
                                <h6 className="text-muted f-w-300 mt-4">Blocked Leads <span className="float-right">120</span></h6>
                                <h6 className="text-muted f-w-300 mt-4 mb-0">Buy Leads <span className="float-right">245</span></h6>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className='Active-visitor'>
                        <Card.Body className='text-center'>
                            ...
                            <div className="progress mt-4 m-b-40">
                                <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '75%', height: '7px'}} aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"/>
                            </div>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <div className="row align-items-center justify-content-center">
                                <div className="col-auto">
                                    <h3 className="f-w-300 m-t-20">$73,48<i className="fa fa-caret-up text-c-green f-26 m-l-10"/></h3>
                                    <span>EARNINGS</span>
                                </div>
                                <div className="col text-right">
                            ...
                            <div className="leads-progress mt-3">
                                <h6 className="mb-3 text-center">Quality <span className="ml-4">Delivery</span></h6>
                                <div className="progress">
                                    <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '30%', height: '10px'}} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"/>
                                    <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '35%', height: '10px'}} aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"/>
                                </div>
                                <h6 className="text-muted f-w-300 mt-4">Total Cost <span className="float-right">340</span></h6>
                                <h6 className="text-muted f-w-300 mt-4">Quality Of Product <span className="float-right">65%</span></h6>
                                <h6 className="text-muted f-w-300 mt-4">Delivery Period <span className="float-right">4 Days</span></h6>
                                <h6 className="text-muted f-w-300 mt-4 mb-0">Buy Product <span className="float-right">245</span></h6>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className='theme-bg'>
                        <Card.Body>
                            ...
                            <div className="m-t-50">
                                <h6 className="text-white">Monthly Profit <span className="float-right text-white">$340</span></h6>
                                <h6 className="text-white mt-3">Weekly Profit <span className="float-right text-whitw">$150</span></h6>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className='theme-bg Invoice-bar'>
                        <Card.Body>
                            <div className="invoice-lable text-right">
                                <span><label className="label f-14">monthly</label></span>
                            </div>
                            <div className="row">
                                <div className="col-auto">
                                ...
                                <div className="col">
                                    ...
                                    <div className="progress mt-3">
                                        <div className="progress-bar bg-white" role="progressbar" style={{width: '50%', height: '7px'}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                            </div>
                        </Card.Body>
                ...
                <Col md={6} xl={4}>
                    <Card className='theme-bg location-sale'>
                        <Card.Body>
                            ...
                            <h5 className="text-white mt-3">Location Sale <span className="float-right">23% <i className="fa fa-arrow-down text-white"/></span></h5>
                            <h3 className="text-white d-flex align-items-center justify-content-between m-t-50 mb-0">$1372,05 <span className="float-right f-16">+ $23,13 (12%)</span></h3>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body className='ticket-visitor'>
                            ...
                            <div className="progress">
                                <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '72%', height: '13px'}} aria-valuenow="72" aria-valuemin="0" aria-valuemax="100">72%</div>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col md={6} xl={4}>
                    <Card className='affilate-offers'>
                        <Card.Body>
                            <h5>Affiliate <span className="float-right"><i className="card-icon fa fa-anchor f-24"/></span></h5>
                            <h2 className="mt-4 mb-0 d-flex align-items-center justify-content-between f-w-300">3,789 <label className="label theme-bg text-white f-12 f-w-400 float-right">4+</label></h2>
                            <h6 className="d-flex align-items-center justify-content-center  mt-3">From First week 13.5% <i className="fa fa-caret-up text-c-green f-26 m-l-10"/></h6>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card className='affilate-offers'>
                        <Card.Body>
                            <h5>Offers<span className="float-right"><i className="card-icon fa fa-gift f-24"/></span></h5>
                            <h2 className="mt-4 mb-0 d-flex align-items-center justify-content-between f-w-300">2,586 <label className="label theme-bg text-white f-12 f-w-400 float-right">10+</label></h2>
                            <h6 className="d-flex align-items-center justify-content-center mt-3">From Last week 15.5% <i className="fa fa-caret-up text-c-green f-26 m-l-10"/></h6>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <h5 className="text-muted"><span className="f-14 mr-1">Deposits:</span>$10,000</h5>
                            <h5 className="mt-3 text-c-blue mb-4"><i className="fa fa-caret-down text-c-blue f-22"></i> 5.2% ($456)</h5>
                            <Link to='#' className="btn btn-primary shadow-2 text-uppercase btn-block" style={{maxWidth: '150px', margin: '0 auto'}}>add funds</Link>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card className='theme-bg earning-date'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white'>Page View</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <div className='bd-example bd-example-tabs'>
                                <Tab.Container id="left-tabs-example" defaultActiveKey="mon">
                                    <Tab.Content>
                                        <Tab.Pane eventKey="mon">
                                            <h2 className="text-white mb-3 f-w-300">9,456<i className="feather icon-arrow-up"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="tue">
                                            <h2 className="text-white mb-3 f-w-300">8,568<i className="feather icon-arrow-down"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="wed">
                                            <h2 className="text-white mb-3 f-w-300">3,756<i className="feather icon-arrow-up"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="thu">
                                            <h2 className="text-white mb-3 f-w-300">9,635<i className="feather icon-arrow-up"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="fri">
                                            <h2 className="text-white mb-3 f-w-300">23,486<i className="feather icon-arrow-down"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="sat">
                                            <h2 className="text-white mb-3 f-w-300">86,789<i className="feather icon-arrow-up"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="sun">
                                            <h2 className="text-white mb-3 f-w-300">93,628<i className="feather icon-arrow-down"></i></h2>
                                            <span className="text-white mb-4 d-block">TOTAL VIEWS</span>
                                        </Tab.Pane>
                                    </Tab.Content>
                                    <Nav variant="pills" className='align-items-center justify-content-center'>
                ...
                <Col md={6} xl={4}>
                    <Card className='project-task'>
                        <Card.Body>
                            <div className="row align-items-center justify-content-center">
                                <div className="col">
                                    <h5 className="m-0"><i className="fa fa-edit m-r-10"/>Project Task</h5>
                                </div>
                                <div className="col-auto">
                        ...
                        <Card.Body>
                            ...
                            <div className="media summary-box mb-4">
                                <div className="photo-table">
                                    <h3 className="m-0 f-w-300">$1935.26 <i className="fa fa-caret-up text-c-green f-26 m-l-8"/></h3>
                                    <span>Profit</span>
                                </div>
                            ...
                            <div className="media summary-box mb-4">
                                <div className="photo-table">
                                    <h3 className="m-0 f-w-300">$2356.42 <i className="fa fa-caret-up text-c-green f-26 m-l-8"/></h3>
                                    <span>Invoiced</span>
                                </div>
                                <div className="media-body">
                                    <i className="card-icon feather icon-download float-right f-34"/>
                            ...
                            <div className="media summary-box mb-4">
                                <div className="photo-table">
                                    <h3 className="m-0 f-w-300">$4683.96 <i className="fa fa-caret-down text-c-red f-26 m-l-8"/></h3>
                                    <span>Expenses</span>
                                </div>
                                <div className="media-body">
                                    <i className="card-icon feather icon-download float-right f-34"/>
                            ...
                            <Link to='#' className="btn btn-primary shadow-2 text-uppercase btn-block" style={{maxWidth: '150px', margin: '0 auto'}}>add friend</Link>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card className='statistial-visit'>
                        ...
                        <Card.Body>
                            ...
                            <span className="d-block"><i className="fa fa-map-marker m-r-10"/>256 Countries, 5667 Cites </span>
                            ...
                            <div className="media mt-4">
                                <div className="photo-table">
                                    <h6> Our Overseas visits</h6>
                                    <div className="progress">
                                        <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '60%', height: '6px'}} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                                <div className="media-body">
                            ...
                            <div className="media mt-4">
                                <div className="photo-table">
                                    <h6> Our Overseas visits</h6>
                                    <div className="progress">
                                        <div className="progress-bar progress-c-blue" role="progressbar" style={{width: '60%', height: '6px'}} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                                <div className="media-body">
