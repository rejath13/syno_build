                ...
                <Col md={6} xl={4}>
                    <Card className='chat-sanders'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white'>Chat with Kristina Sanders</Card.Title>
                        </Card.Header>
                            ...
                            <div className="right-icon-control">
                                <div className="input-group input-group-button p-10">
                                    ...
                                    <div className="input-group-append">
                                        <button className="btn" type="button"><i className="fa f-20 fa-paper-plane"></i></button>
                                    </div>
                                </div>
                            </div>
                        </Card.Footer>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <div className="row m-t-35">
                                ...
                                <div className="col-6">
                                    <Link to='#' className="btn text-uppercase border btn-block btn-outline-secondary p-15">message</Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                        ...
                        <Card.Body>
                            <div className="row">
                                ...
                                <div className="to-do-button">
                                    <button className="btn btn-primary btn-round"><i className="fa fa-plus f-14 mr-0"/></button>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                        ...
                        <Card.Body>
                            <div className="row">
                                <div className="col-xl-12 mb-4">
                                    <h6 className="m-b-20 text-center">Facebook <span className="ml-4">Twitter</span></h6>
                                    <div className="progress">
                                        <h5 className="m-r-20 m-b-0">67%</h5>
                                        <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '40%', height: '12px'}} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"/>
                                        <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '40%', height: '12px'}} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"/>
                                        <h5 className="m-l-20 m-b-0">23%</h5>
                                    </div>
                                    <h6 className="m-t-20 text-center text-muted">5326 <span className="m-l-15">234</span></h6>
                                </div>
                                <div className="col-xl-12  mb-4">
                                    <h6 className="m-b-20 text-center">Pinterest <span className="ml-4">Instagram</span></h6>
                                    <div className="progress">
                                        <h5 className="m-r-20 m-b-0">46%</h5>
                                        <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '30%', height: '12px'}} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"/>
                                        <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '35%', height: '12px'}} aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"/>
                                        <h5 className="m-l-20 m-b-0">54%</h5>
                                    </div>
                                    <h6 className="m-t-20 text-center text-muted">2856 <span className="m-l-15">5258</span></h6>
                                </div>
                                <div className="col-xl-12  mb-0">
                                    <h6 className="m-b-20 text-center">YouTube <span className="ml-4">Vimeo</span></h6>
                                    <div className="progress">
                                    ...
                                    <h6 className="m-t-20 text-center text-muted">2989 <span className="m-l-15">2873</span></h6>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
