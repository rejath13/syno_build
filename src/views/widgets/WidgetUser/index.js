            ...
            <Row>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <h6 className="m-b-0">$2356.23 <span className="float-right">$3200.00</span></h6>
                    ...
                    <Card>
                        <Card.Body>
                            <Row className='align-items-center justify-content-center'>
                                ...
                                <Col>
                                    <h5 className="m-t-35">Dashboard UI Kit</h5>
                                    <h6 className="m-b-0">$2356.23 <span className="float-right">$32</span></h6>
                                    <div className="progress m-t-10" style={{height: '7px'}}>
                                        <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '69%'}} aria-valuenow="69" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </Col>
                        ...
                        <Card.Body className='p-sm-0'>
                            <Row className='align-items-center justify-content-center'>
                                ...
                                <Col className='pt-3 pt-sm-0 pl-3 pl-sm-0'>
                                    <h4>$59,48 <i className="fa fa-caret-up text-c-green f-22 m-l-5"/></h4>
                                    <span>EARNINGS</span>
                                </Col>
                            </Row>
                        </Card.Body>
                    ...
                    <Card>
                        <Card.Body>
                            <Row className='align-items-center justify-content-center'>
                                ...
                                <Col>
                                    <h5 className="m-t-35">Dashboard UI Kit</h5>
                                    <h6 className="m-b-0">$2463.23 <span className="float-right">$64</span></h6>
                                    <div className="progress m-t-10" style={{height: '7px'}}>
                                        <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '40%'}} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </Col>
                            </Row>
                        </Card.Body>
                        ...
                        <Card.Body>
                            ...
                            <Card.Img className='mt-4' width='100%' src={dashboard1} />
                                <ul className="design-image">
                                    <li>
                                        <button className="btn bg-muted"><i className="fa fa-plus f-14 mr-0"/></button>
                                    </li>
                                    <li><img className="rounded-circle" style={{width: '40px'}} src={avatar1} alt="chat-user"/></li>
                                    <li><img className="rounded-circle" style={{width: '40px'}} src={avatar2} alt="chat-user"/></li>
                                    <li><img className="rounded-circle" style={{width: '40px'}} src={avatar3} alt="chat-user"/></li>
                ...
                <Col md={6} xl={4}>
                    <Card>
                        ...
                        <Card.Body className='post-emoticon'>
                            ...
                            <ul>
                                <li className="m-r-25"><i className="far fa-smile f-26 text-c-green m-r-10"/>235</li>
                                <li className="m-r-25"><i className="far fa-smile f-26 text-c-purple m-r-10"/>95</li>
                                <li className="m-r-0"><i className="far fa-smile f-26 text-c-red m-r-10"/>18</li>
                            </ul>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card>
                        <Card.Body className='p-0'>
                            ...
                            <div className="ux-designer">
                                <button className="btn btn-primary"><i className="fa fa-plus f-14 mr-0"/></button>
                ...
                <Col md={6} xl={4}>
                    <Card className='theme-bg2 visa-top'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white float-left'>John Doe</Card.Title>
                ...
                <Col md={6} xl={4}>
                    <Card className='theme-bg visa-top'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white float-left'>Villads Johansen</Card.Title>
                            <img src={masterLogo} className='img-fluid float-right' alt='card title' />
                        </Card.Header>
                        <Card.Body className='visa'>
                            <h6 className="f-w-600 text-white ">NOT VALID <span className="f-w-300 m-l-10">10/17</span></h6>
                ...
                <Col md={6} xl={4}>
                    <Card className='bg-c-blue visa-top'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white float-left'>Silje Larsen</Card.Title>
                            <img src={ruPayLogo} className='img-fluid float-right' alt='card title' />
                        </Card.Header>
                        <Card.Body className='visa'>
                            <h6 className="f-w-600 text-white ">VALID <span className="f-w-300 m-l-10">09/18</span></h6>
                        ...
                        <Card.Body className='p-0'>
                            <div className="row align-items-center justify-content-center">
                                <div className="col-auto">
                                    <img className="img-fluid rounded-circle" style={{width: '80px'}} src={avatar3} alt="dashboard-user"/>
                                </div>
                                <div className="col">
                                    <h5>Villads Johansen</h5>
                                    <span><i className="fa fa-map-marker f-18 m-r-5"/> Berlin, Germany</span>
                                </div>
                            </div>
                            <div className="border-top"/>
                            <div className="loction-progress">
                                <h6 className="m-b-10">Twitter<span className="float-right">Google +</span></h6>
                                ...
                                <h6 className="m-b-10 m-t-20">Facebook <span className="float-right">Youtube</span></h6>
                                <div className="progress">
                                ...
                                <h5 className="f-w-300 m-t-20  text-muted">60%<span className="float-right">40%</span></h5>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Body>
                            ...
                            <h6 className=" m-b-0">754 Points <span className="float-right">1000</span></h6>
                            <div className="progress m-t-10" style={{height: '7px'}}>
                    ...
                    <Card className='user-designer'>
                        <Card.Body className='text-center'>
                            ...
                            <div className="designer m-t-30">
                                <Link to='#' className="btn btn-primary shadow-2 text-uppercase btn-block">add friend</Link>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={6} xl={4}>
                    <Card className='Design-sprint theme-bg2'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white' >Project Design Sprint</Card.Title>
                        ...
                        <Card.Body>
                            ...
                            <ul className="design-image">
                                <li>
                                    <button className="btn bg-white"><i className="fa fa-plus f-14 mr-0"/></button>
                                </li>
                                <li><img className="rounded-circle" style={{width: '40px'}} src={avatar1} alt="chat-user"/></li>
                                <li><img className="rounded-circle" style={{width: '40px'}} src={avatar2} alt="chat-user"/></li>
                                <li><img className="rounded-circle" style={{width: '40px'}} src={avatar3} alt="chat-user"/></li>
                        ...
                        <Card.Body>
                            ...
                            <ul className="task-list">
                                <li>
                                    ...
                                    <h6>Anton Knudsen<span className="float-right text-muted">14 MAY</span></h6>
                        ...
                        <Card.Body className='p-0'>
                            ...
                            <div className="project-main">
                                <div className="row text-center">
                                    <div className="col-md-4 col-6">
                                        <h6 className="text-muted"><i className="fa fa-star m-r-5"/> 4.8</h6>
                                    </div>
                                    <div className="col-md-4 col-6">
                                        <h6 className="text-muted"><i className="fa fa-map-marker m-r-5"/>USA</h6>
                                    </div>
                                    <div className="col-md-4 col-12">
                                        <h6 className="text-muted m-0"><i className="fas fa-file-alt m-r-5"/> 28 Task</h6>
                                    </div>
                                </div>
                            </div>
                        </Card.Body>
