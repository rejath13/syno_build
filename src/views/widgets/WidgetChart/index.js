        ...
        <React.Fragment>
            <Row>
                    ...
                    <Card className='card-command'>
                        ...
                        <Card.Body>
                            <div className="comment-bar">
                                <h6 className="text-uppercase text-muted">COMMENTERS<span className="text-uppercase float-right">view all</span></h6>
                                <div className="row align-items-center justify-content-center mt-4">
                                    <div className="col">
                                        <h6 className="mb-0">
                                            <img className="rounded-circle mr-2 ml-2" style={{width: '40px'}} src={avatar2} alt="activity-user text-uppercase"/>
                ...
                <Col xl={4} md={6}>
                    <Card className='theme-bg gradientcolor'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white'>Statistics</Card.Title>
                        </Card.Header>
                        <Card.Body className='p-0'>
                            <div className="p-2 text-center">
                                <Link to='#' className="text-white text-uppercase f-w-400">Month</Link>
                                <Link to='#' className="btn btn-round bg-white text-uppercase mx-3 px-4 f-w-400">Week</Link>
                                <Link to='#' className="text-white text-uppercase f-w-400">Day</Link>
                            </div>
                            <div className="my-3 text-center text-white">
                                <Link to='#' className=" d-block mb-1">$78.89 <span className="feather icon-arrow-up"/></Link>
                        ...
                        <Card.Body className='border-top'>
                            <div className="row">
                                <div className="col text-center">
                                    <span className="theme-bg d-block rounded-circle mx-auto mb-2" style={{width: '10px', height: '10px'}}/>
                                    <h6 className="mb-2">53</h6>
                                    <h6 className="mt-2 mb-0">Sport</h6>
                                </div>
                                <div className="col text-center">
                                    <span className="theme-bg2 d-block rounded-circle mx-auto mb-2" style={{width: '10px', height: '10px'}}/>
                                    <h6 className="mb-2">13</h6>
                                    <h6 className="mt-2 mb-0">Music</h6>
                                </div>
                                <div className="col text-center">
                                    <span className="bg-c-blue d-block rounded-circle mx-auto mb-2" style={{width: '10px', height: '10px'}}/>
                                    <h6 className="mb-2">30</h6>
                                    <h6 className="mt-2 mb-0">Travel</h6>
                                </div>
                                <div className="col text-center">
                                    <span className="bg-c-red d-block rounded-circle mx-auto mb-2" style={{width: '10px', height: '10px'}}/>
                    ...
                    <Card className='bg-c-blue'>
                        ...
                        <Card.Body style={{padding: '0 25px'}}>
                            <div className="earning-text mb-4">
                                <h3 className="mb-3 text-white f-w-300">$4295.36 <i className="feather icon-arrow-up teal accent-3"/></h3>
                        ...
                        <Card.Body>
                            ...
                            <div className="row mb-3">
                                <div className="col">
                                    ...
                                    <div className="progress" style={{height: '5px'}}>
                                        <div className="progress-bar progress-c-green" role="progressbar" style={{width: '23%'}} aria-valuenow="23" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                                <div className="col">
                                    <span className="mb-1 text-muted d-block">14%</span>
                                    <div className="progress" style={{height: '5px'}}>
                                        <div className="progress-bar progress-c-yellow" role="progressbar" style={{width: '14%'}} aria-valuenow="14" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                            </div>
                            <div className="row mb-2">
                                <div className="col">
                                    ...
                                    <div className="progress" style={{height: '5px'}}>
                                        <div className="progress-bar progress-c-purple" role="progressbar" style={{width: '35%'}} aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                                <div className="col">
                                    <span className="mb-1 text-muted d-block">28%</span>
                                    <div className="progress" style={{height: '5px'}}>
                                        <div className="progress-bar progress-c-blue" role="progressbar" style={{width: '28%'}} aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"/>
                                    </div>
                                </div>
                            </div>
                        </Card.Body>
                        ...
                        <Card.Body>
                            ...
                            <div className="row">
                                <div className="col-sm-12 pt-3 pb-3 border-top">
                                    <span className="mr-3"><i className="feather icon-circle text-c-green  mr-2"/>Desktop</span>
                                    <span className="float-right">41.6 %</span>
                                </div>
                                <div className="col-sm-12 pt-3 pb-3 border-top">
                                    <span className="mr-3"><i className="feather icon-circle text-c-blue  mr-2"/>Mobile</span>
                                    <span className="float-right">32.5 %</span>
                                </div>
                                <div className="col-sm-12 pt-3 border-top">
                                    <span className="mr-3"><i className="feather icon-circle text-c-purple  mr-2"/>Tablet</span>
                ...
                <Col xl={4} md={6}>
                    <Card className='pb-0'>
                        <Card.Header>
                            <Card.Title as='h5'><img className="rounded-circle m-r-10" style={{width: '40px'}} src={avatar3} alt="activity-user"/> Jonas Nielsen</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            ...
                            <div className="client-name">
                                <div className="row">
                                    <div className="col-sm-12 pt-2 pb-2">
                                        <span className="mr-3"><i className="feather icon-circle text-c-green  mr-2"/>Main wallet</span>
                                        <span className="float-right text-muted">$194.42</span>
                                    </div>
                                    <div className="col-sm-12 pt-2 pb-2">
                                        <span className="mr-3"><i className="feather icon-circle text-c-blue  mr-2"/>Travel</span>
                                        <span className="float-right text-muted">$86.48</span>
                                    </div>
                                    <div className="col-sm-12 pt-2">
                                        <span className="mr-3"><i className="feather icon-circle text-c-purple  mr-2"/>Food & Drink</span>
                ...
                <Col xl={4} md={6}>
                    <Card className='theme-bg2'>
                        <Card.Header className='borderless'>
                            <Card.Title as='h5' className='text-white'>Stats</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            <div className="row">
                ...
                <Col xl={4} md={6}>
                    <Card className='progress-gender'>
                        ...
                        <Card.Body>
                            <h6 className="m-b-10">Female <span className="float-right">Male</span></h6>
                            ...
                            <h5 className="f-w-300 m-t-20  text-muted">62%<span className="float-right">28%</span></h5>
                            <h6 className="m-b-10 m-t-20">Female <span className="float-right">Male</span></h6>
                            <div className="progress">
                                <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '40%', height: '10px'}} aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"/>
                                <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '30%', height: '10px'}} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"/>
                            </div>
                            <h5 className="f-w-300 m-t-20  text-muted">60%<span className="float-right">50%</span></h5>
                            <h6 className="m-b-10 m-t-20">Female <span className="float-right">Male</span></h6>
                            <div className="progress">
                                <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '50%', height: '10px'}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"/>
                                <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '52%', height: '10px'}} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"/>
                            </div>
                            <h5 className="f-w-300 m-t-20  text-muted">50%<span className="float-right">50%</span></h5>
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4} md={6}>
