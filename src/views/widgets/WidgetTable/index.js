        ...
        <React.Fragment>
            <div className="media friendlist-box align-items-center justify-content-center m-b-20">
                <div className="m-r-10 photo-table">
                    <Link to='#'><img className="rounded-circle" style={{width: '40px'}} src={avatar1} alt="activity-user"/></Link>
                </div>
            ...
            <div className="media friendlist-box align-items-center justify-content-center m-b-20">
                <div className="m-r-10 photo-table">
                    <Link to='#'><img className="rounded-circle" style={{width: '40px'}} src={avatar2} alt="activity-user"/></Link>
                </div>
                <div className="media-body">
            ...
            <div className="media friendlist-box align-items-center justify-content-center m-b-20">
                <div className="m-r-10 photo-table">
                    <Link to='#'><img className="rounded-circle" style={{width: '40px'}} src={avatar3} alt="activity-user"/></Link>
                </div>
                <div className="media-body">
                        ...
                        <Card.Body className='pb-0'>
                            <Table responsive hover>
                                ...
                                <tr>
                                    ...
                                    <td className="text-right"><i className="fa fa-circle text-c-red f-10"/></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className="text-right"><i className="fa fa-circle text-c-purple f-10"/></td>
                                </tr>
                                <tr>
                                    <td>
                                        <h6 className="m-0"><img className="rounded-circle  m-r-10" style={{width: '40px'}} src={avatar1} alt="activity-user"/>Ida Jorgensen</h6>
                    ...
                    <Card className='Application-list'>
                        ...
                        <Card.Body className='pb-0'>
                            <Table responsive hover>
                                ...
                                <tbody>
                                <tr>
                                    <td><img className="rounded-circle" style={{width: '50px'}} src={avatar2} alt="activity-user"/></td>
                                    <td>
                                    ...
                                    <td><Link to='#' className="text-white label theme-bg f-12">Active</Link></td>
                                </tr>

                                <tr>
                                    <td><img className="rounded-circle" style={{width: '50px'}} src={avatar1} alt="activity-user"/></td>
                                    <td>
                                    ...
                                    <td><Link to='#' className="label theme-bg2 f-12 text-white">Not Active</Link></td>
                                </tr>

                                <tr>
                                    <td><img className="rounded-circle" style={{width: '50px'}} src={avatar3} alt="activity-user"/></td>
                                    <td>
                                    ...
                                    <td><Link to='#' className="label bg-c-blue f-12 text-white">Paused</Link></td>
                                </tr>
                                </tbody>
                            </Table>
                        </Card.Body>
                        ...
                        <Card.Body className='pb-0'>
                            <Table responsive hover>
                                ...
                                <tr>
                                    ...
                                    <td><span className="pie_1">326,134</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p className="m-0">Assigned to<span className="text-c-green"> Marcus Poulsen</span></p>
                                    </td>
                                    <td><span className="pie_2">110,134</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p className="m-0">Assigned to<span className="text-c-green"> Felix Johansen</span></p>
                                    </td>
                                    <td><span className="pie_3">226,134</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><span className="pie_4">500,134</span></td>
                                    <td>
                        ...
                        <Card.Body className='pb-0'>
                            <Table responsive hover>
                                ...
                                <tr>
                                    ...
                                    <td><Link to='#' className="label theme-bg f-12 text-white">Active</Link></td>
                                    <td className="text-right"><Link to='#'><i className="fa fa-star f-18 text-c-yellow"/></Link>
                                        <Link to='#'><i className="fa fa-star f-18 text-c-yellow"/></Link>
                                        <Link to='#'><i className="fa fa-star f-18 text-c-yellow"/></Link>
                                        <Link to='#'><i className="fa fa-star f-18 text-c-yellow"/></Link>
                                        <Link to='#'><i className="fa fa-star f-18 text-black-50"/></Link>
                                    </td>
                                </tr>
                        ...
                        <Card.Body className='pb-0'>
                            <Table responsive hover>
                                ...
                                <tr className="unread">
                                    ...
                                    <td><Link to='#' className="label theme-bg2 text-white f-12">Reject</Link><Link to='#' className="label theme-bg text-white f-12">Approve</Link></td>
                                </tr>
                                <tr className="unread">
                                    <td><img className="rounded-circle" style={{width: '40px'}} src={avatar2} alt="activity-user"/></td>
                                    <td>
