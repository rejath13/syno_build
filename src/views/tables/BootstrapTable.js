                ...
                <Col>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>variant="dark"</code> with <code>Table</code> component</span>
                        </Card.Header>
                        <Card.Body>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>className="table-*"</code> with <code>tr</code> element</span>
                        </Card.Header>
                        <Card.Body>
                            <Table responsive>
                                <thead>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>className="bg-* text-*"</code> with <code>tr</code> element</span>
                        </Card.Header>
                        <Card.Body>
                            <Table responsive>
                                <thead>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>className="table-columned"</code> with <code>Table</code> component</span>
                        </Card.Header>
                        <Card.Body>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>className="table-*"</code> with <code>thead</code> element</span>
                        </Card.Header>
                        <Card.Body>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>className="table-*"</code> with <code>tfoot</code> element</span>
                        </Card.Header>
                        <Card.Body>
                            <Table responsive className="table-styling">
                                <thead>
                    ...
                    <Card>
                        <Card.Header>
                            ...
                            <span className="d-block m-t-5">use props <code>variant="info"</code> with <code>Table</code> component</span>
                        </Card.Header>
                        <Card.Body>
