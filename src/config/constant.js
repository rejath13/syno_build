...
export const API_URL = 'https://locatoralerts.com/control/react_api/public/index.php/';
export const DtoDApi_URL = 'https://locatoralerts.com/control/react_api/public/index.php/dtod/';
...
export const implementationType = [
    ...
    { label: "LOCATOR+SECUREPATH PREMIUM", value: "LOCATOR+SECUREPATH PREMIUM" },

    { label: "LOCATOR+RASID", value: "LOCATOR+RASID"},
